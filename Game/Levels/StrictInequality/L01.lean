...
Introduction "We will prove the foundational result that `#` is a consistent inequality. [[If this level crashes, reload the page. I do not know why this is happening. Should get fixed before shipping.]]"
...
Statement sineq_consistent {X : Type} [SO X] {a b : X} : ¬(a # b) ↔ ¬((a <ₛ b) ∨ (b <ₛ a)) := by
